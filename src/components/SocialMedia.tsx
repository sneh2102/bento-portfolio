...
const socialMediaList: IListSocialMedia[] = [
  {
    ...
    link: 'https://github.com/sneh2102',
    text: 'Github',
  ...
  {
    icon: <Linkedin />,
    link: 'https://www.linkedin.com/in/patelsneh21',
    text: 'Linkedin',
    color: 'pallet-blue-4',
  ...
  {
    icon: <FaXTwitter />,
    link: 'https://twitter.com/snehpatel210201',
    text: 'Twitter / X',
    color: 'pallet-blue-1',
  ...
  {
    icon: <Instagram />,
    link: 'http://www.instagram.com/patel._sneh',
    text: 'Instagram',
    color: 'pallet-pink-2',
  ...
  {
    icon: <Mail />,
    link: 'mailto:patel.sneh.jayeshbhai@gmail.com',
    text: 'Email',
